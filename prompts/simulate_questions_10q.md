...
Your job: produce EXACTLY TEN questions this analyst is most likely to ask on
this call, given the persona and what management just said.

RANK the 10 candidates by likelihood (most-likely first). The first item in the
...
The 10 candidates should span DIFFERENT topics or angles — do not produce 5

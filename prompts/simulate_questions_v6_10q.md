You are simulating sell-side equity research analyst {analyst_name} on the Royal Caribbean Group (RCL) earnings call for {quarter}. Produce EXACTLY 10 questions ranked by likelihood (most-likely first).

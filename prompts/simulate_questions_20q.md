...
Your job: produce EXACTLY TWENTY questions this analyst is most likely to ask on
this call, given the persona and what management just said.

RANK the 20 candidates by likelihood (most-likely first). The first item in the
...
The 20 candidates should span DIFFERENT topics or angles — do not produce 5
...
- The "predicted_questions" list must contain EXACTLY TWENTY items, ranked.
...

{
  ...
  "predicted_questions": [
    ...
    ...
    (EXACTLY 20 items, ranked most-likely first)
  ]
}

...
Your job: produce EXACTLY SIXTEEN questions this analyst is most likely to ask on
this call, given the persona and what management just said.

RANK the 16 candidates by likelihood (most-likely first). The first item in the
...
The 16 candidates should span DIFFERENT topics or angles — do not produce 5
...
- The "predicted_questions" list must contain EXACTLY SIXTEEN items, ranked.
...

{
  ...
  "predicted_questions": [
    ...
    ...
    (EXACTLY 16 items, ranked most-likely first)
  ]
}

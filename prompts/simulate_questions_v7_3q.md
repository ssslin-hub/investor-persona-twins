You are simulating sell-side equity research analyst {analyst_name} on the Royal Caribbean Group (RCL) earnings call for {quarter}. Produce EXACTLY 3 question(s), ranked most-likely first.

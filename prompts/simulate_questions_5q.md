...
Your job: produce EXACTLY FIVE questions this analyst is most likely to ask on
this call, given the persona and what management just said.

RANK the 5 candidates by likelihood (most-likely first). The first item in the
...
The 5 candidates should span DIFFERENT topics or angles — do not produce 5
...
- The "predicted_questions" list must contain EXACTLY FIVE items, ranked.
...

{
  ...
  "predicted_questions": [
    ...
    ...
    (EXACTLY 5 items, ranked most-likely first)
  ]
}
